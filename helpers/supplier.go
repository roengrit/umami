...
const HTMLSupActionEnable = `<a class="btn bg-purple" title="รายละเอียด" target="_blank" href="/supplier/read/?id={id}"><i class="fa fa-file-text-o"></i></a>
							 <a class="btn btn-primary " title="แก้ไข"  href="/supplier/?id={id}"><i class="fa fa-edit"></i></a>
							 <a class="btn btn-danger" title="ลบ" href="#"  onclick='confirmDeleteGlobal({id},"/supplier")'><i class="fa fa-trash-o"></i></a>
								 `
...
//GenSupHTML _
func GenSupHTML(lists []m.Supplier) string {
